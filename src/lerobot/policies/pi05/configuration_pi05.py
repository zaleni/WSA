...
@DatasetConfig.register_subclass("pi05")
@dataclass
class PI05DatasetConfig(DatasetConfig):
    height: int = 224
    width: int = 224
        ...
        default_factory=lambda: TransformGroup(
            inputs=[
                ...
                ResizeImagesWithPadFn(
                    height=PI05DatasetConfig.height, 
                    width=PI05DatasetConfig.width, 
                ),  # ✅  
                NormalizeTransformFn(),# ✅
                ComposeFieldsTransform(),  # ✅
                PI05GemmaTokenizerTransformFn(),  # ✅
                PadStateAndActionTransformFn(
                    max_state_dim=PI05DatasetConfig.max_state_dim, 
                    max_action_dim=PI05DatasetConfig.max_action_dim, 
                ),  # ✅
