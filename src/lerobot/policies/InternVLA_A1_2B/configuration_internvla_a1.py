...
from lerobot.policies.InternVLA_A1_2B.transform_internvla_a1 import InternVL3TokenizerTransformFn, UnifyInternA1InputsTransformFn


@DatasetConfig.register_subclass("interna1")
@dataclass
class InternA1DatasetConfig(DatasetConfig):
    height: int = 448
    width: int = 448
        ...
        default_factory=lambda: TransformGroup(
            inputs=[
                ...
                ResizeImagesWithPadFn(
                    height=InternA1DatasetConfig.height, 
                    width=InternA1DatasetConfig.width, 
                ),  # ✅
                InternVL3TokenizerTransformFn(),  # ✅
                NormalizeTransformFn(),  # ✅
                ComposeFieldsTransform(),  # ✅
                PadStateAndActionTransformFn(
                    max_state_dim=InternA1DatasetConfig.max_state_dim, 
                    max_action_dim=InternA1DatasetConfig.max_action_dim, 
                ),  # ✅
                RemapImageKeyTransformFn(),  # ✅
                UnifyInternA1InputsTransformFn(),  # ✅
            ],
            outputs=[]
        )
    )
...
@PreTrainedConfig.register_subclass("interna1")
@dataclass
class InternA1Config(PreTrainedConfig):
